...
namespace elenora.Migrations
{
    ...
    [Migration("20210213125556_ComponentIdString")]
    partial class ComponentIdString
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("elenora.Models.HoroscopeBraceletCartItem", b =>
                {
                    b.HasBaseType("elenora.Models.CartItem");

                    b.Property<int?>("BraceletSize")
                        .HasColumnName("HoroscopeBraceletCartItem_BraceletSize")
                        .HasColumnType("integer");

                    b.Property<int>("HoroscopeBraceletId")
                        .HasColumnType("integer");

                    b.HasIndex("HoroscopeBraceletId");

                    b.HasDiscriminator().HasValue("HoroscopeBraceletCartItem");
                });
            ...
            modelBuilder.Entity("elenora.Models.HoroscopeBraceletOrderItem", b =>
                {
                    b.HasBaseType("elenora.Models.OrderItem");

                    b.Property<int?>("BraceletSize")
                        .HasColumnName("HoroscopeBraceletOrderItem_BraceletSize")
                        .HasColumnType("integer");
                    ...
                    b.HasDiscriminator().HasValue("HoroscopeBraceletOrderItem");
                });
            ...
            modelBuilder.Entity("elenora.Models.HoroscopeBraceletCartItem", b =>
                {
                    b.HasOne("elenora.Models.HoroscopeBracelet", "HoroscopeBracelet")
                        .WithMany()
                        .HasForeignKey("HoroscopeBraceletId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
