...
namespace elenora.Migrations
{
    ...
    [Migration("20210706190708_PromotionEndDateOptional")]
    partial class PromotionEndDateOptional
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("elenora.BusinessModels.Bracelet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("elenora.Features.ProductFeeds.ProductFeedVisibility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("ProductFeedVisibilities");
                });

            modelBuilder.Entity("elenora.Features.ProductPricing.ProductDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("elenora.Models.Component", b =>
                {
                    ...
                    b.Property<string>("ExampleImageDescription")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("elenora.Models.ComponentImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("elenora.Models.ComponentSupplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("elenora.Models.Faq", b =>
                {
                    ...
                    b.Property<int>("HoroscopeBraceletsOpenCount")
                        .HasColumnType("integer");

                    b.Property<int>("HoroscopeBraceletsOrder")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("elenora.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("elenora.Models.Order", b =>
                {
                    ...
                    b.Property<string>("ShippingPointAddressInformation")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("elenora.Models.OrderHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("elenora.Models.ProductComponentCoordinates", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("ProductComponentCoordinates");
                });

            modelBuilder.Entity("elenora.Models.ProductStatistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("elenora.Features.StringBraceletDesigner.StringBraceletCartItem", b =>
                {
                    ...
                    b.Property<string>("FlapColor1")
                        .HasColumnType("text");

                    b.Property<string>("FlapColor2")
                        .HasColumnType("text");

                    b.Property<string>("KnotColor")
                        .HasColumnType("text");

                    b.Property<string>("StringColor1")
                        .HasColumnType("text");

                    b.Property<string>("StringColor2")
                        .HasColumnType("text");

                    b.Property<string>("StringColor3")
                        .HasColumnType("text");

                    b.HasDiscriminator().HasValue("StringBraceletCartItem");
                });
            ...
            modelBuilder.Entity("elenora.Models.CustomBraceletCartItem", b =>
                {
                    ...
                    b.Property<int?>("SecondaryBeadTypeId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SecondaryBeadTypeId");
            ...
            modelBuilder.Entity("elenora.Features.StringBraceletDesigner.StringBraceletOrderItem", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("StringBraceletOrderItem");
                });
            ...
            modelBuilder.Entity("elenora.Models.GiftBraceletOrderItem", b =>
                {
                    b.HasBaseType("elenora.Models.OrderItem");
                    ...
                    b.HasDiscriminator().HasValue("GiftBraceletOrderItem");
                });
            ...
            modelBuilder.Entity("elenora.Features.ProductFeeds.ProductFeedVisibility", b =>
                {
                    b.HasOne("elenora.BusinessModels.Bracelet", "Product")
                        .WithMany("ProductFeedVisibilities")
            ...
            modelBuilder.Entity("elenora.Models.ProductComponentCoordinates", b =>
                {
                    ...
                    b.HasOne("elenora.BusinessModels.Bracelet", "Product")
                        .WithMany("ProductComponentCoordinates")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("elenora.Models.CustomBraceletCartItem", b =>
                {
                    ...
                    b.HasOne("elenora.Models.Component", "SecondaryBeadType")
                        .WithMany()
                        .HasForeignKey("SecondaryBeadTypeId");
                });
